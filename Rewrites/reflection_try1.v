...
Fixpoint KRRealizeExp (e: KRExp) :=
  match e in KRExp return (@KRrealizeType (KRExpType e)) with
  | KRNil KRTypModuleElt => @nil ModuleElt
  | KRNil KRTypRegInitT => @nil RegInitT
  | KRNil _ => @nil DefMethT
  | KRVar t e => e
