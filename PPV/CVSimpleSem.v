...
Section SemSimple.
  ...
  | SemUpdReadReqFalse idxNum num readReg dataArray idx Data isAddr pred writeMap readMap arr old upds
                   ...
                   (HWriteMap : Sem_RME_simple
                                  (UpdReg readReg pred
                                             ...
                                             writeMap) (old, upds)):
      Sem_RME_simple (@UpdReadReq _ _ idxNum num readReg dataArray idx Data isAddr pred writeMap readMap arr) (old, upds)
  | SemAsyncRead (idxNum num : nat) (readPort dataArray : string) (idx : Bit (Nat.log2_up idxNum) @# type) (pred : Bool @# type) (k : Kind) (readMap : RME_simple type RegMapType)
                 old upds (HNoOp : Sem_RME_simple readMap (old, upds)):
      Sem_RME_simple (@AsyncRead _ _ idxNum num readPort dataArray idx pred k readMap) (old, upds)
  ...
  | SemCompAsyncRead_simple num (readPort dataArray : string) idxNum (idx : Bit (Nat.log2_up idxNum) @# type) pred Data readMap lret
